                        ...
                        <form>
                            <div class="m-3">
                                <div class="mb-4 mt-4">
                                    ...
                                    <input type="text" name="name" class="form-control mb-5" id="exampleInputEmail1"
                                ...
                                <button type="submit" class="mb-3 mt-2 btn form-control btn-primary">Отправить</button>
                            </div>
                        </form>
        ...
        <div>
            ...
            <div>
                <div class="collapse" id="collapseWidthExample1">
                    <div class="card card-body text-center">
                        Выбрать товар нажать кнопку купить
                    </div>
                </div>
            </div>
            <p>
            ...
            <div>
                <div class="collapse" id="collapseWidthExample2">
                    <div class="card card-body text-center">
                        После нажатия купить переходим к оформлению и выбрать адрес доставки
                    </div>
                </div>
            </div>
            <p>
            ...
            <div>
                <div class="collapse" id="collapseWidthExample3">
                    <div class="card card-body text-center">
                        после даставки гарантия 12 меесяцев
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top: 20px;">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>3</td>
                        <td>450</td>
                        <td class="table-danger">Cancel</td>
                    </tr>
                    </tbody>
                </table>
            </div>
